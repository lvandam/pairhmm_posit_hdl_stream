...
HD_PWD='/home/laurensvandam/pairhmm_posit_hdl/posit_add/posit_add.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log posit_adder_8bit_tb_v.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source posit_adder_8bit_tb_v.tcl
