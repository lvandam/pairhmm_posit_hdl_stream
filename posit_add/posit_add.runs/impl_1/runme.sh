...
HD_PWD='/home/laurensvandam/pairhmm_posit_hdl/posit_add/posit_add.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log posit_adder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source posit_adder.tcl -notrace
